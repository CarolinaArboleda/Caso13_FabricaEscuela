...
import sistema_organizacion.sistema.usecases.grupo.impl.IngresarGrupoFamiliarInteractor;
...
public class BeanConfig {
    ...
    public CrearGrupoFamiliarUseCase crearGrupoFamiliarUseCase(
        ...
        return new CrearGrupoFamiliarInteractor(
            usuarioOutputPort, grupoOutputPort);
    }
    ...
    public IngresarGrupoFamiliarUseCase ingresarGrupoFamiliarUseCase(
            UsuarioOutputPort usuarioOutputPort,
            GrupoFamiliarOutputPort grupoOutputPort) {
        return new IngresarGrupoFamiliarInteractor(
            usuarioOutputPort, grupoOutputPort);
    }
